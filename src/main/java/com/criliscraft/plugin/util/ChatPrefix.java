...
public class ChatPrefix {
    ...
    public static final String NO_PERMS = "[" + ChatColor.DARK_BLUE + "Cri" + ChatColor.DARK_PURPLE + "Lis " + ChatColor.DARK_GREEN + "Craft" + ChatColor.WHITE + "] " + ChatColor.DARK_RED + "You do not have permission!";
